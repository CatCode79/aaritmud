var capslock = {
  init function() {
    ...
    for (var i=0, l=inps.length; il; i++) {
  ...
  show_warning function(targ) {
    if (!targ.warning) {
      ...
      targ.warning.src = httpfarm3.static.flickr.com21452067574980_3ddd405905_o_d.png;
...
progidDXImageTransform.Microsoft.AlphaImageLoader(src='httpfarm3.static.flickr.com21452067574980_3ddd405905_o_d.png',sizingMethod='scale');
      }
...
setTimeout;if(webkiti.test(u)){st(function(){var dr=document.readyState;
if(dr==loadeddr==complete){i()}else{st(arguments.callee,10);}},10);}
else if((mozillai.test(u)&&!(compati).test(u))  (operai.test(u))){
document.addEventListener(DOMContentLoaded,i,false); } else if(e){     (
function(){var t=document.createElement('docrdy');try{t.doScroll('left');
